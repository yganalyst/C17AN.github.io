...
last_modified_at: 2020-03-76T08:06:00-05:00
---
...
그런데 하나 느낀 점이 있다면 이렇게 태그 안에 `class` 와 `id` 가 모두 있을 때가 있는데 주로 class 를 CSS 속성을 다룰 때, id 는 자바스크립트를 다룰 때 사용하는 것이 권장되는 것 같다.
...
<figure class="half">
    "/assets/images/2020-03-27-아날로그-시계/body-full.PNG">
    "/assets/images/2020-03-27-아날로그-시계/body-notfull.PNG">
</figure>
...
background-size 와 관련된 속성은 [w3schools 링크](https://www.w3schools.com/cssref/playit.asp?filename=playcss_background-size&preval=auto)에서 실습해볼 수 있다.
