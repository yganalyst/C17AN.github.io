...
**implicit conversion** 은 is 연산자나 변수 정의 시 자동으로 수행된다.   

**explicit conversion** 은 다음 메서드를 통해 진행한다.
...
우선 타입에 **굉장히** 민감하고, 자바스크립트와는 정말 판이하게 다른 코딩 스타일을 요구할 것 같아 뭔가 무서워지기 시작했다.   
